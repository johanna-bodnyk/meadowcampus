...
@section('content')
    ...
    <div class="ask row">
        ...
        <div class="col-sm-10">
            ...
            <p>The alumni, staff, and trustees who built this website have all pledged. <a href="/donors" target="_blank">Now we have {{ $total['count'] }} generous donors</a> who have together pledged <strong>${{$total}} to be paid over 10 years,</strong> leaving <strong>${{$remainder}}</strong> yet to raise in about the next month.
