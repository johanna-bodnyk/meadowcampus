...
@section('content')
    ...
    <div class="ask row">
        ...
        <div class="col-sm-10">
            ...
            <p>The alumni, staff, and trustees who built this website (about a dozen of us) have all pledged. <a href="/donors" target="_blank">Now we have pledges of <strong>${{$total}} to be paid over 10 years,</strong></a> leaving <strong>${{$remainder}}</strong> yet to raise in about the next month.
