...
@section('content')
    ...
    <div class="ask row">
        <div class="col-sm-1" id="left-arrow"><a href="/help/3"></a></div>
        <div class="col-sm-10">
            ...
            <p class="slide-number">4 of 10</p>
        </div>
        <div class="col-sm-1" id="right-arrow"><a href="/help/5"></a></div>
    </div>
    <div class="small-ask-pager row">
        <div class="col-xs-6">
            <a href="/help/3" class="btn btn-sm btn-success" role="button">&lt; Previous</a>
        </div>
        <div class="col-xs-6">
            <a href="/help/5" class="btn btn-sm btn-success next-btn" role="button">Next &gt;</a>
        </div>
    </div>
@stop
