...
<!--                <td><a href="https://circleschool.org/meadowpledge?inThe=6.44" class="btn btn-xs btn-success" role="button">Pledge now</a></td>-->
                <td><a href="https://circleschool.org/meadowpledge" class="btn btn-xs btn-success" role="button">Pledge now</a></td>
              </tr>
              <tr>
                <td>$2,015</td>
                <td>$12.98</td>
...
<!--                <td><a href="https://circleschool.org/meadowpledge?inThe=5" target="_blank" class="btn btn-xs btn-success" role="button">Pledge now</a></td>-->
                <td><a href="https://circleschool.org/meadowpledge" target="_blank" class="btn btn-xs btn-success" role="button">Pledge now</a></td>
              </tr>
              <tr>
                <td>$10</td>
                <td>$1,553</td>
...
<!--                    <a id="calc-button1" href="https://circleschool.org/meadowpledge?inThe=64.40" target="_blank" class="btn btn-success" role="button">Pledge $<span id="button-label1">64.40</span>/month</a>-->
                    <a id="calc-button1" href="https://circleschool.org/meadowpledge" target="_blank" class="btn btn-success" role="button">Pledge $<span id="button-label1">64.40</span>/month</a>
                </div>
...
<!--                    <a id="calc-button2" href="https://circleschool.org/meadowpledge?inThe=50.00" target="_blank" class="btn btn-success" role="button">Pledge $<span id="button-label2">50.00</span>/month</a>-->
                    <a id="calc-button2" href="https://circleschool.org/meadowpledge" target="_blank" class="btn btn-success" role="button">Pledge $<span id="button-label2">50.00</span>/month</a>
                </div>
